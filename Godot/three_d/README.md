...
**已接通带钱出发、首桌买入、离桌返还、寻找出口和付费撤离；已自动保存资金、库存、牌局和位置，关闭后可继续。** 酒馆还是灰盒；Blender 的三张图像贴图已保留，程序化材质暂用 PBR 基础色，烘焙、人物、音效、其余道具、完整搜索事件、其它撤离路线和正式美术仍待制作。此版不是最终画质样板。
