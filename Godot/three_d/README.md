...
**已接通带钱出发、首桌买入、离桌返还、寻找出口和付费撤离；资金仅在本次运行中保留，关闭程序不保存。** 酒馆还是灰盒；Blender 的三张图像贴图已保留，程序化材质暂用 PBR 基础色，烘焙、人物、音效、存档、完整搜索与库存、第二桌、其它撤离路线和正式美术仍待制作。此版不是最终画质样板。
